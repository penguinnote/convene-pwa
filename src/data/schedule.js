...
export const schedule = [
  { day: "1일차", date: "7/29 (수)", items: [
    ...
    { time: "12:00", title: "점심식사 & 휴식", place: "식당", link: { type: "schedule" } },
    { time: "13:30", title: "개회 메시지", place: "본관 강당", link: { type: "verse", verseId: "opening" } },
    { time: "14:20", title: "휴식 시간", place: "", link: { type: "playlist" } },
    { time: "14:30", title: "레크레이션", place: "본관 강당", link: { type: "team" } },
    { time: "16:15", title: "휴식 시간", place: "", link: { type: "playlist" } },
    { time: "16:30", title: "GBS 1강", place: "각 조", link: { type: "verse", verseId: "gbs-1" } },
    { time: "17:45", title: "저녁식사", place: "식당", link: { type: "schedule" } },
  ...
  { day: "2일차", date: "7/30 (목)", items: [
    ...
    { time: "08:00", title: "아침식사", place: "식당" },
    { time: "09:00", title: "GBS 2강", place: "각 조", link: { type: "verse", verseId: "gbs-2" } },
    { time: "10:15", title: "휴식 시간", place: "", link: { type: "playlist" } },
  ...
  { day: "4일차", date: "8/1 (토)", items: [
    ...
    { time: "12:00", title: "점심식사", place: "식당", link: { type: "schedule" } },
