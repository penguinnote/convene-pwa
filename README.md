...
교회 청년대학부 여름 캠프(80~100명, 3박 4일)를 위해 만든 모바일 웹앱입니다.
...
서비스워커 충돌 등 실제 프로덕션에서 마주치는 문제들을 해결한 것이 핵심입니다.

---

## 🖼️ 첨부 사진

> `docs/` 폴더에 이미지를 넣고 아래 경로를 맞춰주세요.
